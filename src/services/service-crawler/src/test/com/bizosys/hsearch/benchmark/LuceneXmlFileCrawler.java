...
public class LuceneXmlFileCrawler implements XmlRecordExtracterCallback {
	
	private static Logger l = Logger.getLogger(LuceneXmlFileCrawler.class.getName());
	...
	protected LuceneXmlFileCrawler()
	{
	}
	 ...
	 */
	public LuceneXmlFileCrawler(String filePath,
